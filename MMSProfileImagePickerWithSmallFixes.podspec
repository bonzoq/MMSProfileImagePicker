...
Pod::Spec.new do |s|
  s.name             = "MMSProfileImagePickerWithSmallFixes"
  s.version          = "1.6.0"
  ...
  s.homepage         = "https://github.com/bonzoq/MMSProfileImagePicker"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Bonzoq" => "bonzoq@wp.pl" }
  s.source           = { :git => "https://github.com/bonzoq/MMSProfileImagePicker.git", :tag => s.version.to_s }
...
#}
  ...
  s.dependency 'MMSCameraViewControllerWithSmallFixes',  '~> 1.4.2'
